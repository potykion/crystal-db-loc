...
select HeadClue, SingCode, FreqDiel, Temper_2, Constant, Znak, Diel, ErrY, MethodY, Bknumber, LanguageID
...
(ElemTablID, LanguageID, MethodP, Nazbparam)
select ElemTablID, LanguageID, MethodP, Nazbparam
...
(DecrTablID, LanguageID, Nzv, Uzv)
select DecrTablID, LanguageID, Nzv, Uzv
