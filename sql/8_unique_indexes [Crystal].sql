...
ALTER TABLE HeadTablInvariant ADD CONSTRAINT U_HeadTablInvariant UNIQUE (Help, Class)
ALTER TABLE HeadTablLanguage ADD CONSTRAINT U_HeadTablLanguage UNIQUE (HeadTablID, LanguageID, Expert, System)
