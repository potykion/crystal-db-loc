...
set TableNameUrl = (case
  when P.TableName = 'RefrTabl' then 'Review'
	...
	when P.TableName = 'ElOpTabl' then 'ElectroOptical'
	when P.TableName = 'EsOpTabl' then 'ElastoOptical'
	when P.TableName = 'NlOpTabl' then 'NonlinearOptical'
	when P.TableName = 'DecrTabl' then 'Wave'
	when P.TableName = 'AcOpTabl' then 'AcoustoOptical'
